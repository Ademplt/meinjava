...
public class C08_Split {
    public static void main(String[] args) {
        //Verilen bir cumlede istenen harfin kac defa kullanildigini yazdiran bir metod olusturun
    ...
    private static void harfKacKereKullanilmis(String cumle, String harf) {
        ...
        System.out.println("aradiginiz " + harf + " verilen cumlede " + sayac + " kullanilmis");
    }
}
